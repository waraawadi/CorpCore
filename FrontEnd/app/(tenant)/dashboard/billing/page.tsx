    ...
    <div className="p-4 md:p-8 space-y-6">
            ...
            <Card key={module.id} className={checked ? 'ring-2 ring-primary border-primary/40' : ''}>
              ...
              <CardContent className="space-y-3">
                <p className="text-xl font-semibold">
                  {money(module.monthly_price_xof)} XOF / mois
                </p>
                <Button
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          <p className="text-sm">
            <strong>Total proforma:</strong> {money(totalSelected)} XOF
          </p>
            ...
            <DialogContent className="w-[84vw] max-w-[84vw] sm:w-[80vw] sm:max-w-[80vw] max-h-[96vh] overflow-y-auto">
              ...
              <div className="space-y-4">
                <div className="flex flex-wrap items-center justify-between gap-2 text-sm">
                  ...
                  <p><strong>Total a payer:</strong> {money(totalSelected)} XOF</p>
                </div>
                    ...
                    {!proformaLines.length ? (
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex items-center justify-between border-t pt-2">
                          ...
                          <p className="text-base font-bold">{money(totalSelected)} XOF</p>
                        </div>
                        <Button
                          className="w-full"
