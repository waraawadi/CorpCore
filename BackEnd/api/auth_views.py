...
class TenantTokenObtainPairSerializer(TokenObtainPairSerializer):
    ...
    def validate(self, attrs):
        ...
        data["tenant"] = {
            ...
            "currency_code": getattr(tenant, "currency_code", "XOF"),
            "slogan": getattr(tenant, "slogan", ""),
            "logo_url": request.build_absolute_uri(tenant.logo.url) if getattr(tenant, "logo", None) else None,
            "hero_image_url": request.build_absolute_uri(tenant.hero_image.url) if getattr(tenant, "hero_image", None) else None,
